/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 4f9c4003f1fc7f30418a8782576a325c)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	AFFARI_TOKEN: string;
	AFFARI_BASE_URL: string;
	AFFARI_LOGIN_FIELDS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AFFARI_TOKEN" | "AFFARI_BASE_URL" | "AFFARI_LOGIN_FIELDS" | "SESSION_SECRET">> {}
}
